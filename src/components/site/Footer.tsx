      ...
      <div className="max-w-7xl mx-auto px-6 py-16 grid md:grid-cols-3 gap-12">
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm font-serif">
            ...
            <li><Link to="/blog" className="hover:text-gold transition-colors">{t("Православный блог", "Blog ortodox")}</Link></li>
            ...
            <li><Link to="/catalog" className="hover:text-gold transition-colors">{t("Иконы и святыни", "Icoane și obiecte sfinte")}</Link></li>
